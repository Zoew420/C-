...
inline void DrawPressure(float x, float y, float p)
{
    ...
    degree type;
    if (p >= min_pre && p <= min_pre + 0.30f) glColor3ub(128, 138, 135);
    else if (p >= min_pre + 0.30f && p <= min_pre + 0.60f) glColor3ub(192, 192, 192);
    else if (p >= min_pre + 0.60f && p <= min_pre + 0.90f) glColor3ub(220, 220, 220);
    else if (p >= min_pre + 0.90f && p <= min_pre + 1.10f) glColor3ub(248, 248, 255);
    else if (p >= min_pre + 1.10f && p <= min_pre + 1.40f) glColor3ub(176, 224, 230);
    else if (p >= min_pre + 1.40f && p <= min_pre + 1.70) glColor3ub(135, 206, 235);
    else if (p >= min_pre + 1.70f) glColor3ub(51, 161, 201);
    glRectf(x - radius, y - radius, x + radius, y + radius);
}